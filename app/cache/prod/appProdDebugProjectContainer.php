...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/annotations', true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager548f4ff32dfa0_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager548f4ff32dfa0_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_diextra/doctrine/EntityManager_548f4ff32dfa0.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_a4da370933e4d4b3a8f02a879c81d69f');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a4da370933e4d4b3a8f02a879c81d69f');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a4da370933e4d4b3a8f02a879c81d69f');
        ...
        $d->setProxyDir('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager548f4ff32dfa0_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/stephanelevrai/Sites/BigCityLights/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/stephanelevrai/Sites/BigCityLights/app/config/routing.yml', array('cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/sessions');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('fatbotmedia@gmail.com');
        $instance->setPassword('fatbotmedia2014');
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
     ...
     *
     * @return EntityManager548f4ff32dfa0_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/stephanelevrai/Sites/BigCityLights/app/../web', true);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod',
            ...
            'debug.container.dump' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/stephanelevrai/Sites/BigCityLights/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_diextra/doctrine/EntityManager_548f4ff32dfa0.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager548f4ff32dfa0_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/stephanelevrai/Sites/BigCityLights/app/cache/prod/jms_security',
